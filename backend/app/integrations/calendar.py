...
def collect_evidence(project_name: str) -> list[Evidence]:
    """Search Google Calendar for anything about this project and normalize it to Evidence.
...
def execute_action(action: PlannedAction) -> str:
    ...
    raise NotImplementedError(f"Google Calendar action not implemented: {action.action}")
